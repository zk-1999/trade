<template>
  <div class="min1500">
    ...
    >
      <el-form :label-position="labelPosition" label-width="100px">
        ...
        <el-form-item label="备注内容：">
          <el-input type="textarea" :rows="2" placeholder="请输入备注内容"></el-input>
        </el-form-item>
      </el-form>
    ...
    >
      <el-form :label-position="labelPosition" label-width="100px">
        <el-form-item label="部门名称：">
          <el-input placeholder="请输入部门名称" v-model="table[0].a"></el-input>
        </el-form-item>
        <el-form-item label="备注内容：">
          <el-input type="textarea" :rows="2" v-model="table[0].b" placeholder="请输入备注内容"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
